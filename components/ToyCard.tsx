...
export default function ToyCard({ toy, isPlanSelection = false }: ToyCardProps) {
  ...
  return (
    <div className="toy-card bg-white rounded-xl overflow-hidden group shadow-lg hover:shadow-xl transition-shadow duration-300">
      {/* Image Container */}
      <div className="relative h-48 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
        ...
        {isClient && isPlanSelection && isToySelected && (
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          {isClient ? (
            isPlanSelection ? (
              // Show price and select/unselect buttons when in plan selection mode
              <>
              ...
              // Show "Free with Subscription" when NOT in plan selection mode (direct access)
              <>
                <div className="text-lg font-bold text-green-600">
                  Free with Subscription
                </div>
                {/* Add a more prominent tagline */}
